...
public class PolishItemNames
{
    ...
    public static String getPolishName(final Material material, final short dur) {
        ...
        if (material == Material.PISTON_MOVING_PIECE) {
            return "tlok";
        }
        ...
        if (material == Material.SMOOTH_STAIRS) {
        ...
        if (material == Material.NETHER_FENCE) {
        ...
        if (material == Material.REDSTONE_LAMP_OFF) {
            return "lampa na czerwony proszek";
        }
        if (material == Material.REDSTONE_LAMP_ON) {
            return "lampa na czerwony proszek";
        }
        if (material == Material.WOOD_DOUBLE_STEP) {
        ...
        if (material == Material.SPRUCE_WOOD_STAIRS) {
            return "shody z ciemnego drewna";
        }
        if (material == Material.BIRCH_WOOD_STAIRS) {
            return "schody z jasnego drewna";
        }
        if (material == Material.JUNGLE_WOOD_STAIRS) {
        ...
        if (material == Material.COBBLE_WALL) {
            return "brukowy plot";
        }
        ...
        if (material == Material.WOOD_BUTTON) {
        ...
        if (material == Material.IRON_PLATE) {
            return "zelazna plytka";
        }
        if (material == Material.REDSTONE_COMPARATOR_OFF) {
            return "komparator";
        }
        if (material == Material.REDSTONE_COMPARATOR_ON) {
            return "komparator";
        }
        ...
        if (material == Material.HARD_CLAY) {
        ...
        if (material == Material.GRILLED_PORK) {
        ...
        if (material == Material.GOLDEN_APPLE) {
            ...
            if (material == Material.WOOD_DOOR) {
                return "drewniane drzwi";
            }
            ...
            if (material == Material.POWERED_MINECART) {
                return "lokomotywa";
            }
            ...
            if (material == Material.RAW_BEEF) {
                return "tatar";
            }
            if (material == Material.COOKED_BEEF) {
                return "befsztyk";
            }
            if (material == Material.RAW_CHICKEN) {
                return "kurczak";
            }
            ...
            if (material == Material.BOOK_AND_QUILL) {
            ...
            if (material == Material.FLOWER_POT_ITEM) {
                return "doniczka";
            }
            ...
            if (material == Material.CARROT_STICK) {
            ...
            if (material == Material.REDSTONE_COMPARATOR) {
                return "komparator";
            }
            if (material == Material.NETHER_BRICK_ITEM) {
